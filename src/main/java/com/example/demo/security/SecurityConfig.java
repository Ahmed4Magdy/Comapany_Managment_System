...
//
//    // لا حاجة لأي field JwtAuthFilter هنا
//
//    @Bean
...
//
//    @Bean
//    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter, UserInfoService userInfoService) throws Exception {
//        http
